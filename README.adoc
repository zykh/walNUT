...
1. Download https://docs.google.com/file/d/0BxWv_9cok7BKTnBWZTFjVDRyUE0/edit?usp=sharing[this Mallard backend for AsciiDoc]
2. Extract it
+

----
tar -xf mallard-backend.tar.gz
----
...
----
4. Compile your source file (e.g. +manual.txt+) with:
+
